          ...
          <div className="flex flex-col md:flex-row gap-12 items-start max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center gap-6 flex-shrink-0 md:w-64">
              ...
              <div className="flex gap-5 justify-center">
                <a href="mailto:xiang.li@bristol.ac.uk" title="Email" className="transition hover:opacity-80">
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="#0A66C2">
                    <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                  </svg>
                </a>
                <a href="#" title="Twitter" className="transition hover:opacity-80">
                ...
                <a href="#" title="LinkedIn" className="transition hover:opacity-80">
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="#0A66C2">
                    <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z"/>
                    <circle cx="4" cy="4" r="2"/>
                  </svg>
                </a>
                <a href="https://scholar.google.com/citations?user=YOUR_SCHOLAR_ID" title="Google Scholar" className="transition hover:opacity-80">
                ...
                <a href="#" title="GitHub" className="transition hover:opacity-80">
